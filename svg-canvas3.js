var app = new Vue({
  ...
  data() {
    ...
    map(item => item.split('=')).
    reduce((acc, entries) => {
      acc[entries[0]] = decodeURIComponent(entries[1]);
      return acc;
    }, {});
    return {
      inlineStyles: `<style>@import url('${this.importedFont}');</style>`,
      slogan: params.slogan || 'Slogan',
      subtitle: params.subtitle || 'During Covid-19',
      subtitle2: params.subtitle2 || 'FIVE',
      subtitle3: params.subtitle3 || 'Learn More',
      subtitle4: params.subtitle4 || 'More',
      title: params.title || "HEALHTY",
      title2: params.title2 || "PARENTING",
      title3: params.title3 || "TIPS",
      title4: params.title4 || "TIPS",
