         ...
         for (var j = 0; j < entry.link.length; j++)
         {
            if (entry.link[j].rel == "alternate")
            {
               ...
               if (url && url.length > 0 && title && title.length > 0)
               {
                  ...
                  liE.setAttribute('class', "case-item__icon");
                  liE.setAttribute('src', "https://svgshare.com/i/_aE.svg");
                  var l3E = document.createElement('div');
                  
                  var liE = document.createElement('h3');
                  liE.setAttribute('class', "title title--h5");
